...
export declare class ByteStream implements IterableIterator<Uint8Array> {
    ...
    next(value?: any): IteratorResult<Uint8Array<ArrayBufferLike>, null>;
    throw(value?: any): any;
    return(value?: any): any;
    peek(size?: number | null): Uint8Array<ArrayBufferLike>;
    read(size?: number | null): Uint8Array<ArrayBufferLike>;
}
/** @ignore */
export declare class AsyncByteStream implements Readable<Uint8Array>, AsyncIterableIterator<Uint8Array> {
    ...
    next(value?: any): Promise<IteratorResult<Uint8Array<ArrayBufferLike>, null>>;
    throw(value?: any): Promise<any>;
    return(value?: any): Promise<any>;
    get closed(): Promise<void>;
    cancel(reason?: any): Promise<void>;
    peek(size?: number | null): Promise<Uint8Array<ArrayBufferLike>>;
    read(size?: number | null): Promise<Uint8Array<ArrayBufferLike>>;
}
