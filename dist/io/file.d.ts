...
export declare class RandomAccessFile extends ByteStream {
    ...
    read(nBytes?: number | null): Uint8Array<ArrayBufferLike>;
    readAt(position: number, nBytes: number): Uint8Array<ArrayBufferLike>;
    close(): void;
    throw(value?: any): {
        done: boolean;
        value: any;
...
export declare class AsyncRandomAccessFile extends AsyncByteStream {
    ...
    read(nBytes?: number | null): Promise<Uint8Array<ArrayBuffer>>;
    readAt(position: number, nBytes: number): Promise<Uint8Array<ArrayBuffer>>;
    close(): Promise<void>;
