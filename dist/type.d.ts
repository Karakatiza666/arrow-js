...
declare class Int_<T extends Ints = Ints> extends DataType<T> {
    ...
    get ArrayType(): Uint8ArrayConstructor | BigUint64ArrayConstructor | Uint32ArrayConstructor | Int8ArrayConstructor | Int16ArrayConstructor | Uint16ArrayConstructor | Int32ArrayConstructor | BigInt64ArrayConstructor;
    toString(): string;
    protected static [Symbol.toStringTag]: string;
}
export { Int_ as Int };
