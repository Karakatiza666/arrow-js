...
export declare function toIntervalDayTimeInt32Array(objects: IntervalDayTimeObject[]): Int32Array<ArrayBuffer>;
export declare function toIntervalMonthDayNanoInt32Array(objects: Partial<IntervalMonthDayNanoObject>[]): Int32Array<ArrayBuffer>;
