...
export declare class Uint64 extends BaseInt64 {
    ...
    /** @nocollapse */
    static from(val: any, out_buffer?: Uint32Array<ArrayBuffer>): Uint64;
    /** @nocollapse */
    static fromNumber(num: number, out_buffer?: Uint32Array<ArrayBuffer>): Uint64;
    /** @nocollapse */
    static fromString(str: string, out_buffer?: Uint32Array<ArrayBuffer>): Uint64;
    /** @nocollapse */
...
export declare class Int64 extends BaseInt64 {
    ...
    /** @nocollapse */
    static from(val: any, out_buffer?: Uint32Array<ArrayBuffer>): Int64;
    /** @nocollapse */
    static fromNumber(num: number, out_buffer?: Uint32Array<ArrayBuffer>): Int64;
    /** @nocollapse */
    static fromString(str: string, out_buffer?: Uint32Array<ArrayBuffer>): Int64;
    /** @nocollapse */
    static convertArray(values: (string | number)[]): Uint32Array;
    /** @nocollapse */
...
export declare class Int128 {
    ...
    /** @nocollapse */
    static from(val: any, out_buffer?: Uint32Array<ArrayBuffer>): Int128;
    /** @nocollapse */
    static fromNumber(num: number, out_buffer?: Uint32Array<ArrayBuffer>): Int128;
    /** @nocollapse */
    static fromString(str: string, out_buffer?: Uint32Array<ArrayBuffer>): Int128;
    /** @nocollapse */
    static convertArray(values: (string | number)[]): Uint32Array;
}
