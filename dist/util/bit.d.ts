...
/** @ignore */
export declare function truncateBitmap(offset: number, length: number, bitmap: Uint8Array): Uint8Array<ArrayBufferLike>;
/** @ignore */
export declare function packBools(values: Iterable<any>): Uint8Array<ArrayBuffer>;
/** @ignore */
