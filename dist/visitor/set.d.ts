...
/** @ignore */
export declare const setInt: <T extends Int>({ values }: Data<T>, index: number, value: T["TValue"]) => void;
/** @ignore */
...
/** @ignore */
export declare const setAnyFloat: <T extends Float>(data: Data<T>, index: number, value: T["TValue"]) => void;
/** @ignore */
...
export declare const setDate: <T extends Date_>(data: Data<T>, index: number, value: T["TValue"]) => void;
/** @ignore */
...
/** @ignore */
export declare const setTimestamp: <T extends Timestamp>(data: Data<T>, index: number, value: T["TValue"]) => void;
/** @ignore */
...
/** @ignore */
export declare const setTime: <T extends Time>(data: Data<T>, index: number, value: T["TValue"]) => void;
/** @ignore */
export declare const setDecimal: <T extends Decimal>({ values, stride }: Data<T>, index: number, value: T["TValue"]) => void;
/** @ignore */
export declare const setIntervalValue: <T extends Interval>(data: Data<T>, index: number, value: T["TValue"]) => void;
/** @ignore */
...
/** @ignore */
export declare const setDuration: <T extends Duration>(data: Data<T>, index: number, value: T["TValue"]) => void;
/** @ignore */
