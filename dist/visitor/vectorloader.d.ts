...
export declare class VectorLoader extends Visitor {
    ...
    visitUnion<T extends type.Union>(type: T, { length, nullCount }?: FieldNode): Data<type.SparseUnion> | Data<type.DenseUnion>;
    ...
    protected readNullBitmap<T extends DataType>(type: T, nullCount: number, buffer?: BufferRegion): Uint8Array<ArrayBufferLike>;
    protected readOffsets<T extends DataType>(type: T, buffer?: BufferRegion): Uint8Array<ArrayBufferLike>;
    protected readTypeIds<T extends DataType>(type: T, buffer?: BufferRegion): Uint8Array<ArrayBufferLike>;
    protected readData<T extends DataType>(_type: T, { length, offset }?: BufferRegion): Uint8Array<ArrayBufferLike>;
    protected readVariadicBuffers(length: number): Uint8Array<ArrayBufferLike>[];
...
export declare class JSONVectorLoader extends VectorLoader {
    ...
    protected readNullBitmap<T extends DataType>(_type: T, nullCount: number, { offset }?: BufferRegion): Uint8Array<ArrayBuffer>;
...
export declare class CompressedVectorLoader extends VectorLoader {
    ...
    protected readData<T extends DataType>(_type: T, _buffer?: BufferRegion): Uint8Array<ArrayBufferLike>;
}
//# sourceMappingURL=vectorloader.d.ts.map