...
export declare class Message<T extends MessageHeader = any> {
    ...
    /** @nocollapse */
    static encode<T extends MessageHeader>(message: Message<T>): Uint8Array<ArrayBufferLike>;
    /** @nocollapse */
    ...
    get headerType(): T;
    get compression(): BodyCompression;
...
/** @ignore */
declare function decodeBodyCompression(b: _BodyCompression | null): BodyCompression;
/** @ignore */
