...
export declare class RecordBatchWriter<T extends TypeMap = any> extends ReadableInterop<Uint8Array> implements Writable<RecordBatch<T>> {
    ...
    protected _sink: AsyncByteQueue<Uint8Array<ArrayBufferLike>>;
    ...
    [Symbol.asyncIterator](): AsyncByteQueue<Uint8Array<ArrayBufferLike>>;
    toDOMStream(options?: ReadableDOMStreamOptions): ReadableStream<Uint8Array<ArrayBufferLike>>;
